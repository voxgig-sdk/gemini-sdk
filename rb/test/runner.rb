...
module GeminiTestRunner
  ...
  def self.env_override(m)
    live = getenv("GEMINI_TEST_LIVE")
    override = getenv("GEMINI_TEST_OVERRIDE")
    ...
    explain = getenv("GEMINI_TEST_EXPLAIN")
    m["GEMINI_TEST_EXPLAIN"] = explain if explain && !explain.empty?
