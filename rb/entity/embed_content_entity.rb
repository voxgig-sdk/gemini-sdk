...
class EmbedContentEntity
  ...
  def make
    opts = @_entopts.dup
    EmbedContentEntity.new(@_client, opts)
  end
  ...
  # @return [EmbedContent, Hash] the current EmbedContent data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EmbedContent fields)
  def match_get
  ...
  #
  # @param reqdata [EmbedContentCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [EmbedContent, Hash] the created EmbedContent; raises GeminiError on failure
