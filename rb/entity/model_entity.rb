...
class ModelEntity
  ...
  # Load a single Model.
  #
  # @param reqmatch [ModelLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Model.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Model, Hash] the loaded Model; raises GeminiError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Model>, Array] the matching Model items; raises GeminiError on failure
