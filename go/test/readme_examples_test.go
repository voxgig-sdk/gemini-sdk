...
const testSeed = `map[string]any{"entity": map[string]any{"embed_content": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "generate_content": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "interaction": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "list_model": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "model": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
