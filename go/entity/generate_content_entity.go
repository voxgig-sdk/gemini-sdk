...
type GenerateContentEntity struct {
	name    string
	client  *core.GeminiSDK
...
func NewGenerateContentEntity(client *core.GeminiSDK, entopts map[string]any) *GenerateContentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GenerateContentEntity) GetName() string { return e.name }
...
func (e *GenerateContentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GenerateContentEntity) Deleted() bool {
	return e.deleted
}


func (e *GenerateContentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGenerateContentEntity(e.client, opts)
}

func (e *GenerateContentEntity) Data(args ...any) any {
...
func (e *GenerateContentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GenerateContent; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GenerateContentEntity) DataTyped(data ...GenerateContent) GenerateContent {
	if len(data) > 0 {
		return typedFrom[GenerateContent](e.Data(asMap(data[0])))
	}
	return typedFrom[GenerateContent](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GenerateContent (all fields
// optional at the wire level).
func (e *GenerateContentEntity) MatchTyped(match ...GenerateContent) GenerateContent {
	if len(match) > 0 {
		return typedFrom[GenerateContent](e.Match(asMap(match[0])))
	}
	return typedFrom[GenerateContent](e.Match())
}
...
func (e *GenerateContentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GenerateContentEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *GenerateContentEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *GenerateContentEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GenerateContentCreateData and returns an GenerateContent. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *GenerateContentEntity) CreateTyped(reqdata GenerateContentCreateData, ctrl map[string]any) (GenerateContent, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return GenerateContent{}, err
	}
	return typedFrom[GenerateContent](res), nil
}



func (e *GenerateContentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GenerateContentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GenerateContentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
