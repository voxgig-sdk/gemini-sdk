...
func NewListModelEntity(client *core.GeminiSDK, entopts map[string]any) *ListModelEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ListModelEntity) GetName() string { return e.name }
...
func (e *ListModelEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ListModelEntity) Deleted() bool {
	return e.deleted
}


func (e *ListModelEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewListModelEntity(e.client, opts)
}

func (e *ListModelEntity) Data(args ...any) any {
...
func (e *ListModelEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ListModel; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ListModelEntity) DataTyped(data ...ListModel) ListModel {
	if len(data) > 0 {
		return typedFrom[ListModel](e.Data(asMap(data[0])))
	}
	return typedFrom[ListModel](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ListModel (all fields
// optional at the wire level).
func (e *ListModelEntity) MatchTyped(match ...ListModel) ListModel {
	if len(match) > 0 {
		return typedFrom[ListModel](e.Match(asMap(match[0])))
	}
	return typedFrom[ListModel](e.Match())
}
...
func (e *ListModelEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ListModelEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ListModelEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ListModelEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ListModelEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ListModelEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ListModelEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
