...
func NewEmbedContentEntity(client *core.GeminiSDK, entopts map[string]any) *EmbedContentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EmbedContentEntity) GetName() string { return e.name }
...
func (e *EmbedContentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EmbedContentEntity) Deleted() bool {
	return e.deleted
}


func (e *EmbedContentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEmbedContentEntity(e.client, opts)
}

func (e *EmbedContentEntity) Data(args ...any) any {
...
func (e *EmbedContentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EmbedContent; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EmbedContentEntity) DataTyped(data ...EmbedContent) EmbedContent {
	if len(data) > 0 {
		return typedFrom[EmbedContent](e.Data(asMap(data[0])))
	}
	return typedFrom[EmbedContent](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EmbedContent (all fields
// optional at the wire level).
func (e *EmbedContentEntity) MatchTyped(match ...EmbedContent) EmbedContent {
	if len(match) > 0 {
		return typedFrom[EmbedContent](e.Match(asMap(match[0])))
	}
	return typedFrom[EmbedContent](e.Match())
}
...
func (e *EmbedContentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EmbedContentEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *EmbedContentEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *EmbedContentEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EmbedContentCreateData and returns an EmbedContent. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EmbedContentEntity) CreateTyped(reqdata EmbedContentCreateData, ctrl map[string]any) (EmbedContent, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return EmbedContent{}, err
	}
	return typedFrom[EmbedContent](res), nil
}



func (e *EmbedContentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EmbedContentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EmbedContentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
