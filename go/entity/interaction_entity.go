...
func NewInteractionEntity(client *core.GeminiSDK, entopts map[string]any) *InteractionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InteractionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
