...
// Gemini SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class GeminiMakeRequest
{
    public static function call(GeminiContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new GeminiResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new GeminiResponse($fetched);
        } else {
