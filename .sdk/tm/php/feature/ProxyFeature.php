...
class GeminiProxyFeature extends GeminiBaseFeature
{
    ...
    public function init(GeminiContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GeminiContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
