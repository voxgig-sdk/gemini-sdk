...
class GeminiNetsimFeature extends GeminiBaseFeature
{
    ...
    private function _simulate(GeminiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(GeminiContext $ctx, array $applied): void
    {
        $client = $this->client;
