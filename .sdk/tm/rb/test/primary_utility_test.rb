...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = GeminiOmni.make_runner(TEST_JSON_FILE, GeminiSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : GeminiOmni.errify(err)
    end
