...
|---|---|---|
| `ts/` | @voxgig-sdk/gemini-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/gemini-sdk \
      --repository voxgig-sdk/gemini-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/gemini-sdk` shows it, and
`npm trust revoke @voxgig-sdk/gemini-sdk --id=<id>` removes it.
