...
(0, node_test_1.describe)('InteractionEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != interaction_ref01_data);
    });
});
