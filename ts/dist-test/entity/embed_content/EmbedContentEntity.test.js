...
(0, node_test_1.describe)('EmbedContentEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'embed_content.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != embed_content_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/embed_content/EmbedContentTestData.json');
    ...
    let idmap = transform(['embed_content01', 'embed_content02', 'embed_content03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GEMINI_TEST_EMBED_CONTENT_ENTID'];
...
//# sourceMappingURL=EmbedContentEntity.test.js.map