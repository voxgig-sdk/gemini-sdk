...
// Gemini SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GeminiSDK::test)
...
{
    private const SDK_CLASS = 'GeminiSDK';
    ...
    private const SDK_BASE = 'gemini_sdk';
