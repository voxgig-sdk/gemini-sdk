...
class GeminiTestRunner
{
    ...
    {
        $live = self::getenv('GEMINI_TEST_LIVE');
        $override = self::getenv('GEMINI_TEST_OVERRIDE');
        ...
        $explain = self::getenv('GEMINI_TEST_EXPLAIN');
...
class_alias('GeminiTestRunner', 'Runner');
class_alias('GeminiHelpers', 'Helpers');
