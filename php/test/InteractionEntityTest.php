...
class InteractionEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set GEMINI_TEST_INTERACTION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function interaction_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("GEMINI_TEST_INTERACTION_ENTID");
