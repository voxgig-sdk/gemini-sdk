...
class GeminiFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GeminiSDK/1.0)';
    ...
    public static function call(GeminiContext $ctx, string $fullurl, array $fetchdef): array
    {
