...
class ListModelEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ListModelEntity($this->_client, $opts);
    }

    /**
     * @param ListModel|array $args ListModel data (assoc-array) to store.
     */
    ...
    /**
     * @return ListModel|array The current ListModel data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ListModel fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ListModel fields).
     */
