...
// Gemini SDK EmbedContent entity
...
class EmbedContentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EmbedContentEntity($this->_client, $opts);
    }

    /**
     * @param EmbedContent|array $args EmbedContent data (assoc-array) to store.
     */
    ...
    /**
     * @return EmbedContent|array The current EmbedContent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EmbedContent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EmbedContent fields).
     */
    ...
    /**
     * Create a new EmbedContent.
     *
     * @param EmbedContentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EmbedContentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmbedContent|array The created EmbedContent as an assoc-array at the
