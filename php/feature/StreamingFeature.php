...
class GeminiStreamingFeature extends GeminiBaseFeature
{
    ...
    private function _iterate(GeminiResult $result): \Generator
    {
    ...
    private function _streamable(GeminiContext $ctx): bool
    {
