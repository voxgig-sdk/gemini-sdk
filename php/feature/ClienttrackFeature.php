...
// Gemini SDK clienttrack feature
...
class GeminiClienttrackFeature extends GeminiBaseFeature
{
    ...
    public function PostConstruct(GeminiContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Gemini-SDK';
