...
class GeminiRbacFeature extends GeminiBaseFeature
{
    ...
    private function _required(GeminiContext $ctx): ?string
    {
    ...
    private function _reject(GeminiContext $ctx, string $required): void
    {
    ...
    private function _track(GeminiContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
