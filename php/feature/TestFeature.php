...
// Gemini SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class GeminiTestFeature extends GeminiBaseFeature
{
    ...
    public function init(GeminiContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (GeminiContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (GeminiContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(GeminiContext $ctx, $op, $args): array
    {
