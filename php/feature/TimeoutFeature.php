...
class GeminiTimeoutFeature extends GeminiBaseFeature
{
    ...
    private function _with_timeout(GeminiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GeminiContext $_ctx, float $ms): void
    {
        $client = $this->client;
