...
class GeminiCacheFeature extends GeminiBaseFeature
{
    ...
    private function _through(GeminiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
