...
class GeminiRatelimitFeature extends GeminiBaseFeature
{
    ...
    private function _acquire(GeminiContext $ctx): void
    {
    ...
    private function _track(GeminiContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
