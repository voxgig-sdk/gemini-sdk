...
-- data to return.
local TEST_SEED = '{ entity = { ["embed_content"] = { ["test01"] = { id = "test01" } }, ["generate_content"] = { ["test01"] = { id = "test01" } }, ["interaction"] = { ["test01"] = { id = "test01" } }, ["list_model"] = { ["test01"] = { id = "test01" } }, ["model"] = { ["test01"] = { id = "test01" } } } }'
