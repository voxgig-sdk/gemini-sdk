...
func registerSDKWords(r *eng.Registry, client *sdk.GeminiSDK) {
...
func runOp(client *sdk.GeminiSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
