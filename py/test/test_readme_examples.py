# Gemini SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GeminiSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GeminiSDK(...) and GeminiSDK.test(...) become
#      GeminiSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "gemini_sdk"
_SDK_CLASS = "GeminiSDK"
