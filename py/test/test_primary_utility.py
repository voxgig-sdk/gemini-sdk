...
from gemini_sdk.core.result import GeminiResult
from gemini_sdk.core.response import GeminiResponse
from gemini_sdk.core.operation import GeminiOperation
from gemini_sdk.core.error import GeminiError
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = GeminiSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = GeminiSDK.test(None, None)
        ...
        class TestInitFeature(GeminiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(GeminiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = GeminiSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = GeminiSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = GeminiSDK.test(None, setup_opts)
