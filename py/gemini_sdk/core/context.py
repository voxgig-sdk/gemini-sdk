...
from gemini_sdk.core.control import GeminiControl
...
from gemini_sdk.core.helpers import get_ctx_prop, to_map
...
class GeminiContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, GeminiResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return GeminiError(code, msg, self)
