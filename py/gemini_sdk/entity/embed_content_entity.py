...
class EmbedContentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EmbedContentEntity(self._client, opts)
    ...
    def data_get(self) -> EmbedContent:
    ...
    def match_get(self) -> EmbedContent:
    ...
    def create(self, reqdata: EmbedContentCreateData, ctrl=None) -> EmbedContent:
        utility = self._utility
