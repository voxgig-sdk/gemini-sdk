...
from gemini_sdk.gemini_types import (
    GenerateContent,
...
class GenerateContentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GenerateContentEntity(self._client, opts)
    ...
    def data_get(self) -> GenerateContent:
    ...
    def match_get(self) -> GenerateContent:
    ...
    def create(self, reqdata: GenerateContentCreateData, ctrl=None) -> GenerateContent:
        utility = self._utility
